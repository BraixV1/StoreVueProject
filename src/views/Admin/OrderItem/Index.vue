...
let OrderItems = ref<IOrderItemInfo[]>([])
...
const filteredOrderItems = computed(() => {
    switch (filterParam.value) {
        case 'kbname':
            return OrderItems.value.filter((orderItem) =>
                orderItem.keyboard?.name.toLowerCase().includes(searchQuery.value.toLowerCase())
            )
        case 'pname':
            return OrderItems.value.filter((orderItem) =>
                orderItem.part?.partName.toLowerCase().includes(searchQuery.value.toLowerCase())
            )
        case 'orderid':
            return OrderItems.value.filter((orderItem) =>
                orderItem.orderId?.toLowerCase().includes(searchQuery.value.toLowerCase())
            )
        case 'user':
            return OrderItems.value.filter((orderItem) =>
