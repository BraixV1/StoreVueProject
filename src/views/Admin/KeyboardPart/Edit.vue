...
const fetch = async () => {
    ...
    if (keyboardPartResponse.data) {
        PartId.value = keyboardPartResponse.data.partId;
        KeyboardId.value = keyboardPartResponse.data.keyboardId;
    }
}

const doUpdate = async () => {
    const res = await KeyboardPartService.UpdateKeyboardPart(keyboardPartId.value, KeyboardId.value, PartId.value);
    if (res.data){
        errors.value = []
        router.push('../Index');
    }
