...
const DoDelete = async () => {
    ...
    const res = await KeyboardPartService.DeleteKeyboardPart(keyboardPartId.value)
...
<template>
    ...
    <div class="rounded-lg bg-white p-8 shadow-2xl">
        ...
        <div class="mt-4 flex gap-2">
            ...
            <button @click.prevent="router.push('../Index')" type="button" className="rounded bg-gray-50 px-4 py-2 text-sm font-medium text-gray-600">
            No, go back
            </button>
        </div>
    </div>
