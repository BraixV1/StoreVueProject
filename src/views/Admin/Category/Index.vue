...
<template>
  ...
  <div v-else class="overflow-x-auto min-w-full">
    ...
    >
      ...
      <span class="text-sm font-medium transition-all group-hover:ms-4"> Add new Category </span>
    </router-link>
      ...
      <tbody class="divide-y divide-gray-200">
        <tr v-for="category in filteredCategories" :key="category.id">
          ...
          <td class="whitespace-nowrap px-4 py-2 text-gray-700">
            {{ category.partCategories.length }}
          </td>
          <td class="whitespace-nowrap px-4 py-2 text-right">
            <div class="inline-flex rounded-lg border border-gray-100 bg-gray-100 p-1">
              ...
              <router-link
                :to="`/Keyboard/Details/${category.id}`"
                class="inline-flex items-center gap-2 rounded-md px-4 py-2 text-sm text-gray-500 hover:text-gray-700 focus:relative"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
