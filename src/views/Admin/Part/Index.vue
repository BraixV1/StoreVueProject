    ...
    <div v-else class="overflow-x-auto min-w-full">
        <div class="pb-2 flex flex-col md:flex-row gap-3">
            ...
            >
                ...
                <option value="pcode">part code</option>
        ...
        >
            ...
            <span class="text-sm font-medium transition-all group-hover:ms-4"> Add New Part</span>
        </router-link>
        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
            <thead class="text-left">
                <tr>
                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Part name</th>
                    <th class="whitespace-nowrap px-4 py-2 font-medium text-gray-900">Part code</th>
            ...
            <tbody class="divide-y divide-gray-200">
                <tr v-for="part in filteredParts" :key="part.id">
                    ...
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ part.partCode }}</td>
