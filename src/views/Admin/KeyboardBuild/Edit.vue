...
const doUpdate = async () => {
    try {
        const res = await KeyboardBuildService.Update(keyboardBuildId.value, Name.value, Description.value);
        if (res.data){
        router.push('../Index');
    }
    } catch (error) {
    ...
    <div class="flex">
      <div class="flex-1 flex justify-left pl-10">
        ...
        <form class="space-y-6">
          ...
          <div>
            <label class="block text-sm font-medium leading-6 text-gray-900">Build description</label>
            <div class="mt-2">
