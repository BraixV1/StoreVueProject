    ...
    <div v-else class="overflow-x-auto min-w-full">
        <div class="pb-2 flex flex-col md:flex-row gap-3">
            ...
            >
                ...
                <option value="ordernr">order nr</option>
        ...
        >
            ...
            <span class="text-sm font-medium transition-all group-hover:ms-4"> Add New Order </span>
        </router-link>
        <table class="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
            ...
            <tbody class="divide-y divide-gray-200">
                <tr v-for="order in filteredOrders" :key="order.id">
                    ...
                    <td class="whitespace-nowrap px-4 py-2 text-gray-700">{{ order.orderDate }}</td>
