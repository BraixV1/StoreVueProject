    ...
    <ul class="space-y-1">
      ...
      <li>
        <details class="group [&_summary::-webkit-details-marker]:hidden">
          <summary
            class="group flex items-right justify-between rounded-lg px-4 py-2 text-gray-500 hover:bg-gray-100 hover:text-gray-700"
          >
            <div class="flex items-center gap-2">
              ...
              <span class="text-sm font-medium"> Domain CRUD </span>
            </div>
